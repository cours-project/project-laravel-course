...
<form action="{{ route('admin.lesson.store',$id) }}" method="post">
    ...
    <div class="row">
        ...
        <div class="col-4">
            <div class="mb-3">
                ...
                <select name="parent_id"
                    class=" select {{ $errors->has('parent_id') ? 'is-invalid' : '' }}">
        ...
        <div class="col-4">
            <div class="mb-3">
                ...
                <input type="number" class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}"
                    name="position" placeholder="Thứ tự..." value="{{old('position') ? old('position') : "$position"}}" />
                @error('position')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="col-12">
            ...
            <a href="{{route('admin.lesson.index', $id)}}" class="btn btn-danger">Hủy</a>
        </div>
    </div>
</form>
@endsection